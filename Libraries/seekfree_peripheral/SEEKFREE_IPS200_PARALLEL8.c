...
{
	gpio_init(IPS200_D0_PIN, GPO, 0, GPIO_PIN_CONFIG); 
	gpio_init(IPS200_D1_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_D2_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_D3_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_D4_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_D5_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_D6_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_D7_PIN, GPO, 0, GPIO_PIN_CONFIG); 
	
	gpio_init(IPS200_BL_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_CS_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_RST_PIN,GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_RS_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_WR_PIN, GPO, 0, GPIO_PIN_CONFIG);
	gpio_init(IPS200_RD_PIN, GPO, 0, GPIO_PIN_CONFIG);
